...
export default function NutritionActivityTimeline() {
  const { activityFeed } = useNutritionStore();
  ...
  if (activityFeed.length === 0) {
    return (
      ...
      >
        ...
        <h4 style={{ margin: '0 0 4px 0', color: 'var(--text-main)' }}>No nutrition history yet</h4>
        <p style={{ fontSize: '13px', margin: 0 }}>
          Log your first meal or add hydration to start building your nutrition activity history.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <h3 style={{ margin: '0 0 16px 0', fontSize: '18px', fontWeight: 800 }}>Nutrition Activity Timeline</h3>
